...
*Note*: xFormers may raise the Runtime error: `Triton Error [CUDA]: device kernel image is invalid`.  
...
1) Take care of the dataloading:  
  ...
  c) `BxCxHxW` format  
  d) If any intrinsics given, adapt them accordingly to your resizing  
...
<table border="0">
    ...
    <tr>
        <td>ViT-B</td>
        <td><a href="https://huggingface.co/lpiccinelli/unidepth-v2-vitb14">unidepth-v2-vitb14</a></td>
    </tr>
    <tr>
        <td>ViT-L</td>
...
UniDepthV2old is actually the V1 version updated to compensate for wave artifacts due to wrong LiDAR accumulation.
...
This software is released under the Creative Commons BY-NC 4.0 license. You can view a license summary [here](LICENSE).


## Acknowledgement

We would like to express our gratitude to [@niels](https://huggingface.co/nielsr) for helping integrate UniDepth into Hugging Face.
